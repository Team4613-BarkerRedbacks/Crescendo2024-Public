 ...
 */
@Deprecated
public class CopiedCtreSwerveModule {
    /**
    ...
    private final PositionDutyCycle angleSetter = new PositionDutyCycle(0).withEnableFOC(true);
    ...
    private final VelocityDutyCycle velocitySetter = new VelocityDutyCycle(0).withEnableFOC(true);
     ...
     */
    public CopiedCtreSwerveModule(SwerveModuleConstants constants, String canbusName) {
    ...
    public void apply(SwerveModuleState state, DriveRequestType driveRequestType, SteerRequestType steerRequestType) {
        ...
        double angleToSetRotations = optimized.angle.getRotations();
        ...
        //         break;
        // }
        m_steerMotor.setControl(angleSetter.withPosition(angleToSetRotations));

        double velocityToSet = optimized.speedMetersPerSecond * m_driveRotationsPerMeter;

        /* From FRC 900's whitepaper, we add a cosine compensator to the applied drive velocity */
        /* To reduce the "skew" that occurs when changing direction */
        double steerMotorError = angleToSetRotations - m_steerPosition.getValue();
        ...
        //         break;
        // }
        m_driveMotor.setControl(velocitySetter.withVelocity(velocityToSet));
    }
    ...
    public void applyCharacterization(Rotation2d steerTarget, VoltageOut driveRequest)
    {
        ...
        //         break;
        // }
        m_steerMotor.setControl(angleSetter.withPosition(angleToSetDeg));
