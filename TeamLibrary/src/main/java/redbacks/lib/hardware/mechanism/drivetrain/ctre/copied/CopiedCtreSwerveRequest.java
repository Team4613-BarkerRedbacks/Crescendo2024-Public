 ...
 */
package redbacks.lib.hardware.mechanism.drivetrain.ctre.copied;
 ...
 * 
 * @deprecated The 2025 CTRE library will likely support more appropriate methods of module angle control
 */
@Deprecated
public interface CopiedCtreSwerveRequest {
     ...
     */
    public StatusCode apply(SwerveControlRequestParameters parameters, CopiedCtreSwerveModule... modulesToApply);
     ...
     * oppose any motion.
     */
    public class SwerveDriveBrake implements CopiedCtreSwerveRequest {

        /**
         * The type of control request to use for the drive motor.
         */
        public CopiedCtreSwerveModule.DriveRequestType DriveRequestType = CopiedCtreSwerveModule.DriveRequestType.OpenLoopVoltage;
        /**
         * The type of control request to use for the steer motor.
         */
        public CopiedCtreSwerveModule.SteerRequestType SteerRequestType = CopiedCtreSwerveModule.SteerRequestType.MotionMagic;
         ...
         * @return this request
         */
        public SwerveDriveBrake withDriveRequestType(CopiedCtreSwerveModule.DriveRequestType driveRequestType) {
         ...
         * @return this request
         */
        public SwerveDriveBrake withSteerRequestType(CopiedCtreSwerveModule.SteerRequestType steerRequestType) {
     ...
     */
    public class FieldCentric implements CopiedCtreSwerveRequest {
        /**
         ...
         */
        public ForwardReference ForwardReference = CopiedCtreSwerveRequest.ForwardReference.OperatorPerspective;
        ...
        public StatusCode apply(SwerveControlRequestParameters parameters, CopiedCtreSwerveModule... modulesToApply) {
            ...
            if (ForwardReference == CopiedCtreSwerveRequest.ForwardReference.OperatorPerspective) {
         ...
         * @return this request
         */
        public FieldCentric withDriveRequestType(CopiedCtreSwerveModule.DriveRequestType driveRequestType) {
            this.DriveRequestType = driveRequestType;
            return this;
        }
        /**
         ...
         * @return this request
         */
        public FieldCentric withSteerRequestType(CopiedCtreSwerveModule.SteerRequestType steerRequestType) {
            this.SteerRequestType = steerRequestType;
            return this;
        }
    }
     ...
     */
    public class FieldCentricFacingAngle implements CopiedCtreSwerveRequest {
        /**
         * The velocity in the X direction, in m/s.
         * X is defined as forward according to WPILib convention,
         * so this determines how fast to travel forward.
         ...
         * @return this request
         */
        public FieldCentricFacingAngle withDriveRequestType(CopiedCtreSwerveModule.DriveRequestType driveRequestType) {
            this.DriveRequestType = driveRequestType;
            return this;
        }
        /**
         ...
         * @return this request
         */
        public FieldCentricFacingAngle withSteerRequestType(CopiedCtreSwerveModule.SteerRequestType steerRequestType) {
            this.SteerRequestType = steerRequestType;
            return this;
        }
    }
     ...
     */
    public class Idle implements CopiedCtreSwerveRequest {
        public StatusCode apply(SwerveControlRequestParameters parameters, CopiedCtreSwerveModule... modulesToApply) {
            return StatusCode.OK;
        }
    }
     ...
     */
    public class PointWheelsAt implements CopiedCtreSwerveRequest {
         ...
         * @return this request
         */
        public PointWheelsAt withDriveRequestType(CopiedCtreSwerveModule.DriveRequestType driveRequestType) {
            this.DriveRequestType = driveRequestType;
            return this;
        }
        /**
         ...
         * @return this request
         */
        public PointWheelsAt withSteerRequestType(CopiedCtreSwerveModule.SteerRequestType steerRequestType) {
            this.SteerRequestType = steerRequestType;
            return this;
        }
    }
     ...
     * turn counterclockwise at 0.5 rad/s.
     */
    public class RobotCentric implements CopiedCtreSwerveRequest {
        /**
         * The velocity in the X direction, in m/s.
         * X is defined as forward according to WPILib convention,
         * so this determines how fast to travel forward.
         ...
         * @return this request
         */
        public RobotCentric withDriveRequestType(CopiedCtreSwerveModule.DriveRequestType driveRequestType) {
            this.DriveRequestType = driveRequestType;
            return this;
        }
        /**
         ...
         * @return this request
         */
        public RobotCentric withSteerRequestType(CopiedCtreSwerveModule.SteerRequestType steerRequestType) {
            this.SteerRequestType = steerRequestType;
            return this;
        }
    }
     ...
     */
    public class ApplyChassisSpeeds implements CopiedCtreSwerveRequest {
         ...
         * @return this request
         */
        public ApplyChassisSpeeds withDriveRequestType(CopiedCtreSwerveModule.DriveRequestType driveRequestType) {
            this.DriveRequestType = driveRequestType;
            return this;
        }
        /**
         ...
         * @return this request
         */
        public ApplyChassisSpeeds withSteerRequestType(CopiedCtreSwerveModule.SteerRequestType steerRequestType) {
            this.SteerRequestType = steerRequestType;
            return this;
        }
    }
     ...
     */
    public class SysIdSwerveTranslation implements CopiedCtreSwerveRequest {
     ...
     * characteristics of a swerve drivetrain.
     */
    public class SysIdSwerveRotation implements CopiedCtreSwerveRequest {
        /* Voltage to apply to drive wheels. This is final to enforce mutating the value */
        public final MutableMeasure<Voltage> VoltsToApply = mutable(Volts.of(0));
     ...
     * characteristics of a swerve drivetrain.
     */
    public class SysIdSwerveSteerGains implements CopiedCtreSwerveRequest {
        /* Voltage to apply to drive wheels. This is final to enforce mutating the value */
        public final MutableMeasure<Voltage> VoltsToApply = mutable(Volts.of(0));
