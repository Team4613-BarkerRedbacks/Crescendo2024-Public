...
public class CopiedCtreSwerveDrivetrain {
    ...
    protected CopiedCtreSwerveRequest m_requestToApply = new CopiedCtreSwerveRequest.Idle();
    protected CopiedCtreSwerveRequest.SwerveControlRequestParameters m_requestParameters = new CopiedCtreSwerveRequest.SwerveControlRequestParameters();
     ...
     */
    public CopiedCtreSwerveDrivetrain(SwerveDrivetrainConstants driveTrainConstants, SwerveModuleConstants... modules) {
     ...
     * @param modules                    Constants for each specific module
     */
    public CopiedCtreSwerveDrivetrain(
    ...
    public CopiedCtreSwerveDrivetrain(
        ...
        Modules = new CopiedCtreSwerveModule[ModuleCount];
        ...
        for (SwerveModuleConstants module : modules) {
            Modules[iteration] = new CopiedCtreSwerveModule(module, driveTrainConstants.CANbusName);
     ...
     */
    public void setControl(CopiedCtreSwerveRequest request) {
        try {
            m_stateLock.writeLock().lock();
     ...
     */
    public CopiedCtreSwerveModule getModule(int index) {
